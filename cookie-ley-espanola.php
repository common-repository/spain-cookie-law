 ...
 * Plugin URI: https://www.pedroventura.com/internet/plugin-en-wordpress-cumplir-ley-espanola
 ...
 * @todo conectar con varios servicios, otro ejemplo https://api.hostip.info/get_json.php?ip=XX.XX.XX.XX
*/
function obtener_geo_info() {
	$urlIpCheck = 'https://freegeoip.net/json/' .  $_SERVER['REMOTE_ADDR'];
